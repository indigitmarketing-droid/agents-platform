...
export const EventTypes = {
  ...
  SETTING_SALES_CALL_INITIATED: "setting.sales_call_initiated" as const,
  SETTING_SALES_CALL_COMPLETED: "setting.sales_call_completed" as const,
  SETTING_PAYMENT_LINK_SENT: "setting.payment_link_sent" as const,
  CUSTOMER_ONBOARDED: "customer.onboarded" as const,
  SITE_DELETED_UNPAID: "site.deleted_unpaid" as const,
